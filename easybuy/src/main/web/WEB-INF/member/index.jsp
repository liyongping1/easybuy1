...
<html>
<head>
  <%@include file="../jsp/basic.jsp"%>
  <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/statics/css/style.css" />
  <!--[if IE 6]>
  <script src="${pageContext.request.contextPath}/statics/js/iepng.js" type="text/javascript"></script>
        ...
        <ul>
          <li>
            ...
            <div class="zj">
              ...
              <div class="zj_r">
                <a href="#"><img src="${pageContext.request.contextPath}/statics/images/n_img1.jpg" width="236" height="200" /></a>
                <a href="#"><img src="${pageContext.request.contextPath}/statics/images/n_img2.jpg" width="236" height="200" /></a>
              </div>
            </div>
          </li>
          <li>
            <div class="fj">
              <span class="n_img"><span></span><img src="${pageContext.request.contextPath}/statics/images/nav2.png" /></span>
          ...
          <li>
            <div class="fj">
              <span class="n_img"><span></span><img src="${pageContext.request.contextPath}/statics/images/nav3.png" /></span>
          ...
          <li>
            <div class="fj">
              <span class="n_img"><span></span><img src="${pageContext.request.contextPath}/statics/images/nav4.png" /></span>
          ...
          <li>
            <div class="fj">
              <span class="n_img"><span></span><img src="${pageContext.request.contextPath}/statics/images/nav5.png" /></span>
          ...
          <li>
            <div class="fj">
              <span class="n_img"><span></span><img src="${pageContext.request.contextPath}/statics/images/nav6.png" /></span>
          ...
          <li>
            <div class="fj">
              <span class="n_img"><span></span><img src="${pageContext.request.contextPath}/statics/images/nav7.png" /></span>
          ...
          <li>
            <div class="fj">
              <span class="n_img"><span></span><img src="${pageContext.request.contextPath}/statics/images/nav8.png" /></span>
          ...
          <li>
            <div class="fj">
              <span class="n_img"><span></span><img src="${pageContext.request.contextPath}/statics/images/nav9.png" /></span>
          ...
          <li>
            <div class="fj">
              <span class="n_img"><span></span><img src="${pageContext.request.contextPath}/statics/images/nav10.png" /></span>
...
<div class="i_bg bg_color">
  <div class="i_ban_bg">
    ...
    <div class="banner">
      <div class="top_slide_wrap">
        <ul class="slide_box bxslider">
          <li><img src="${pageContext.request.contextPath}/statics/images/ban1.jpg" width="740" height="401" /></li>
          <li><img src="${pageContext.request.contextPath}/statics/images/ban1.jpg" width="740" height="401" /></li>
          <li><img src="${pageContext.request.contextPath}/statics/images/ban1.jpg" width="740" height="401" /></li>
        </ul>
    ...
    <div class="inews">
      <div class="news_t">
        <span class="fr"><a href="${pageContext.request.contextPath}/news/queryAll?pageNum=1&pageSize=6">更多 ></a></span>新闻资讯
      </div>
      <ul>
      <c:forEach items="${list}" var="news">
        <li><span>[ 公告 ]</span><a href="${pageContext.request.contextPath}/news/queryNewsTitle?title=${news.title}">${news.title}</a></li>
      </c:forEach>
      </ul>
      <div class="charge_t">
  ...
  <div class="content mar_10">
    <div class="h_l_img">
      <div class="img"><img src="${pageContext.request.contextPath}/statics/images/l_img.jpg" width="188" height="188" /></div>
      <div class="pri_bg">
          ...
          <div id="block">
            <div id="botton-scroll">
              <ul class="featureUL">
                <li class="featureBox">
                  <div class="box">
                    <div class="h_icon"><img src="${pageContext.request.contextPath}/statics/images/hot.png" width="50" height="50" /></div>
                    <div class="imgbg">
                ...
                <li class="featureBox">
                  <div class="box">
                    <div class="h_icon"><img src="${pageContext.request.contextPath}/statics/images/hot.png" width="50" height="50" /></div>
                    <div class="imgbg">
                      <a href="#"><img src="${pageContext.request.contextPath}/statics/images/hot2.jpg" width="160" height="136" /></a>
                    </div>
                    <div class="name">
                      <a href="#">
                        <h2>iphone 6S</h2>
                ...
                <li class="featureBox">
                  <div class="box">
                    <div class="h_icon"><img src="${pageContext.request.contextPath}/statics/images/hot.png" width="50" height="50" /></div>
                    <div class="imgbg">
                      <a href="#"><img src="${pageContext.request.contextPath}/statics/images/hot3.jpg" width="160" height="136" /></a>
                    </div>
                    <div class="name">
                      <a href="#">
                        <h2>倩碧特惠组合套装</h2>
                ...
                <li class="featureBox">
                  <div class="box">
                    <div class="h_icon"><img src="${pageContext.request.contextPath}/statics/images/hot.png" width="50" height="50" /></div>
                    <div class="imgbg">
                      <a href="#"><img src="${pageContext.request.contextPath}/statics/images/hot4.jpg" width="160" height="136" /></a>
                    </div>
                    <div class="name">
                      <a href="#">
                        <h2>品利特级橄榄油</h2>
  ...
  <div class="content">
    <div class="i_sell">
      <div id="imgPlay">
        <ul class="imgs" id="actor">
          <li><a href="#"><img src="${pageContext.request.contextPath}/statics/images/tm_r.jpg" width="211" height="357" /></a></li>
          <li><a href="#"><img src="${pageContext.request.contextPath}/statics/images/tm_r.jpg" width="211" height="357" /></a></li>
          <li><a href="#"><img src="${pageContext.request.contextPath}/statics/images/tm_r.jpg" width="211" height="357" /></a></li>
        </ul>
    ...
    <div class="sell_right">
      <div class="sell_1">
        <div class="s_img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/tm_1.jpg" width="185" height="155" /></a></div>
      ...
      <div class="sell_2">
        <div class="s_img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/tm_2.jpg" width="185" height="155" /></a></div>
      ...
      <div class="sell_b1">
        <div class="sb_img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/tm_b1.jpg" width="242" height="356" /></a></div>
        <div class="s_price">￥<span>289</span></div>
        <div class="s_name">
          <h2><a href="#">东北大米</a></h2>
          倒计时：<span>1200</span> 时 <span>30</span> 分 <span>28</span> 秒
      ...
      <div class="sell_3">
        <div class="s_img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/tm_3.jpg" width="185" height="155" /></a></div>
        <div class="s_price">￥<span>289</span></div>
        <div class="s_name">
          <h2><a href="#">迪奥香水</a></h2>
          倒计时：<span>1200</span> 时 <span>30</span> 分 <span>28</span> 秒
      ...
      <div class="sell_4">
        <div class="s_img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/tm_4.jpg" width="185" height="155" /></a></div>
        <div class="s_price">￥<span>289</span></div>
        <div class="s_name">
          <h2><a href="#">美妆</a></h2>
          倒计时：<span>1200</span> 时 <span>30</span> 分 <span>28</span> 秒
      ...
      <div class="sell_b2">
        <div class="sb_img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/tm_b2.jpg" width="242" height="356" /></a></div>
        <div class="s_price">￥<span>289</span></div>
        <div class="s_name">
          <h2><a href="#">美妆</a></h2>
          倒计时：<span>1200</span> 时 <span>30</span> 分 <span>28</span> 秒
    ...
    <div class="fresh_mid">
      <ul>
        <li>
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/fre_1.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">新鲜美味  进口美食</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/fre_2.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">新鲜美味  进口美食</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/fre_3.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">新鲜美味  进口美食</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/fre_4.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">新鲜美味  进口美食</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/fre_5.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">新鲜美味  进口美食</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/fre_6.jpg" width="185" height="155" /></a></div>
        </li>
      </ul>
    </div>
    ...
    <div class="fresh_mid">
      <ul>
        <li>
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/food_1.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">莫斯利安酸奶</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/food_2.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">莫斯利安酸奶</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/food_3.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">莫斯利安酸奶</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/food_4.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">莫斯利安酸奶</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/food_5.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">莫斯利安酸奶</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/food_6.jpg" width="185" height="155" /></a></div>
        </li>
      </ul>
    </div>
    <div class="fresh_right">
    ...
    <div class="fresh_mid">
      <ul>
        <li>
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/make_1.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">美宝莲粉饼</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/make_2.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">美宝莲粉饼</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/make_3.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">美宝莲粉饼</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/make_4.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">美宝莲粉饼</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/make_5.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">美宝莲粉饼</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/make_6.jpg" width="185" height="155" /></a></div>
        </li>
      </ul>
    </div>
    <div class="fresh_right">
    ...
    <div class="fresh_mid">
      <ul>
        <li>
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/baby_1.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">儿童玩具  变形金刚</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/baby_2.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">儿童玩具  变形金刚</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/baby_3.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">儿童玩具  变形金刚</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/baby_4.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">儿童玩具  变形金刚</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/baby_5.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">儿童玩具  变形金刚</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/baby_6.jpg" width="185" height="155" /></a></div>
        </li>
      </ul>
    </div>
    <div class="fresh_right">
    ...
    <div class="fresh_mid">
      <ul>
        <li>
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/home_1.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">品质蓝色沙发</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/home_2.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">品质蓝色沙发</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/home_3.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">品质蓝色沙发</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/home_4.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">品质蓝色沙发</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/home_5.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">品质蓝色沙发</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/home_6.jpg" width="185" height="155" /></a></div>
        </li>
      </ul>
    </div>
    <div class="fresh_right">
    ...
    <div class="fresh_mid">
      <ul>
        <li>
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/tel_1.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">乐视高清电视</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/tel_2.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">乐视高清电视</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/tel_3.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">乐视高清电视</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/tel_4.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">乐视高清电视</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/tel_5.jpg" width="185" height="155" /></a></div>
        </li>
        <li>
          <div class="name"><a href="#">乐视高清电视</a></div>
          <div class="price">
          ...
          <div class="img"><a href="#"><img src="${pageContext.request.contextPath}/statics/images/tel_6.jpg" width="185" height="155" /></a></div>
        </li>
      </ul>
    </div>
    <div class="fresh_right">
          ...
          <div id="botton-scroll1">
            <ul class="featureUL">
              <li class="featureBox">
                <div class="box">
                  <div class="imgbg">
                    <a href="#"><img src="${pageContext.request.contextPath}/statics/images/hot1.jpg" width="160" height="136" /></a>
                  </div>
                  <div class="name">
                    <a href="#">
                      <h2>德国进口</h2>
  ...
  <div class="b_btm_bg b_btm_c">
    <div class="b_btm">
      <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
        <tr>
          <td width="72"><img src="${pageContext.request.contextPath}/statics/images/b1.png" width="62" height="62" /></td>
          <td><h2>正品保障</h2>正品行货  放心购买</td>
        </tr>
      </table>
      <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
        <tr>
          <td width="72"><img src="${pageContext.request.contextPath}/statics/images/b2.png" width="62" height="62" /></td>
          <td><h2>满38包邮</h2>满38包邮 免运费</td>
        </tr>
      </table>
      <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
        <tr>
          <td width="72"><img src="${pageContext.request.contextPath}/statics/images/b3.png" width="62" height="62" /></td>
          <td><h2>天天低价</h2>天天低价 畅选无忧</td>
        </tr>
      </table>
      <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
        <tr>
          <td width="72"><img src="${pageContext.request.contextPath}/statics/images/b4.png" width="62" height="62" /></td>
  ...
  <div class="b_nav">
    ...
    <div class="b_er">
      <div class="b_er_c"><img src="${pageContext.request.contextPath}/statics/images/er.gif" width="118" height="118" /></div>
      <img src="${pageContext.request.contextPath}/statics/images/ss.png" />
    </div>
  </div>
  <div class="btmbg">
    <div class="btm">
